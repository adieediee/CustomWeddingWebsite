...
import animationStyles from "./heroAnimation.module.css";
        ...
        <>
            <section className={styles.hero} ref={_hero_section}>
                <div className={styles.background}>
                    <span
                        className={`${styles.names} ${styles.katka} ${animationStyles.scriptNameBase} ${animationStyles.scriptNameAnimate}`}
                    >
                        Katka
                    </span>
                    <span
                ...
                <div className={`${styles.envelop} ${animationStyles.envelopStart} ${animationStyles.envelopLanding}`}>
                    <Image
                        src={envelop_back}
                        alt="envelop"
            ...
            >
                <Image src={pozvanka} alt="svadobna pozvanka" className={styles.overlay_img} ref={_overlayImg} />
